...
export const noticeList = [
  {
    ...
    content: (
      <Typography whiteSpace="pre-line" sx={{ wordBreak: "break-word" }}>
        {`안녕하세요 고대한자 운영자 한자싫어입니다
        
        저는 글로벌학부 영미학전공 소속으로 문과대학 철학과를 이중전공하여 현재 수료 상태입니다
        기호논리학을 배우던 중 프로그래밍에 흥미가 생겨 부트캠프를 수료하고 현재는 가상공간 스타트업에서 프론트엔드 및 웹 3D 엔지니어로 근무하고 있습니다

        제적 당하지 않기 위해서는 2026년까지 졸업 요건(한자, 토익)을 제출해야 해요
        그런데 졸업 한자 시험이 너무 막막했습니다
        ...
        한자와 프로그래밍 모두 공부해야 하니까요
        따라서 유료 기능을 추가한다거나, 유료 광고를 받는 등의 일은 없을 것입니다
