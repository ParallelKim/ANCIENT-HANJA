...
export const noticeList = [
  {
    title: "사이트 방침에 대한 공지",
    content: (
      <Typography whiteSpace="pre-line" sx={{ wordBreak: "break-word" }}>{`본 서비스는 개인적 공부를 위해 만들어졌습니다
    ...
    content: (
      <Stack color="primary.main">
        {[
          ...
          return (
            <a href={link.url} target="_blank" key={link.label} color="inherit" rel="noreferrer">
              {link.label}
            </a>
          );
        })}
  ...
  },
  {
    title: "업데이트 예정 기능",
    content: (
      <Typography whiteSpace="pre-line" sx={{ wordBreak: "break-word" }}>{`1. 학습 진행도 저장 기능
